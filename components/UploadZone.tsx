...
import { Upload, Check, Sparkles, Lock, ArrowRight, X } from "lucide-react";
import { generateImage, checkGenerationStatus, finalizeGeneration, getCredits } from "@/app/actions";
...
export default function UploadZone() {
    ...
    const [result, setResult] = useState<{ id: string; image: string } | null>(null);
        ...
        try {
            ...
            const interval = setInterval(async () => {
                ...
                if (status.status === "succeeded") {
                    ...
                    // Finalize (Blur & Save)
                    const final = await finalizeGeneration(predictionId, status.output as string);
    ...
    const styles = [
        { id: "formal", label: "Formal", desc: "Suit & Tie", img: "/images/styles/formal.png" },
        { id: "smart-casual", label: "Smart Casual", desc: "Polished but relaxed", img: "/images/styles/smart-casual.jpg" },
        { id: "creative", label: "Creative", desc: "Artistic & Bold", img: "/images/styles/creative.png" },
    ];

    return (
        <>
            <div id="upload-zone" className="w-full max-w-4xl mx-auto p-1 scroll-mt-24">
                ...
                <div className="relative rounded-3xl p-[2px] overflow-hidden">
                    ...
                    <div className="relative bg-white rounded-3xl p-8 shadow-2xl">
                        <h2 className="text-2xl font-bold text-center mb-8 text-gray-800">
                            Create Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">Professional Photo</span>
                        </h2>
                                    ...
                                    >
                                        <div className="text-center mb-6">
                                            ...
                                            <p className="text-gray-500 text-sm">
                                                We'll generate a high-quality {styles.find(s => s.id === style)?.label} headshot for you.
                                            </p>
                                        </div>
